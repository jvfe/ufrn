...
* **Desadenilação e bloqueio do início**: É um dos mecanismos de ação propostos para o ***let-7***, em que este miRNA promove a remoção da cauda poli-A, ou desadenilação, evento este que impede a circularização do mRNA, algo indispensável para o início da tradução.
...
* **Desadenilação e remoção do cap 5'**: Recrutamento de complexos proteicos propiciado pela AGO que vulneraliza o mRNA para as ações de exonucleases.
