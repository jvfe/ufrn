...
- O ecossistema computacional em R não possui soluções nativas para a visualização e manipulação desses dados de forma intuitiva e reprodutível
...
<p align="center">Rede montada na ferramenta descrita</p>
</div>
<div>
...
- A ferramenta possui a opção de transcrever as manipulações realizadas graficamente para manipulações programáticas facilmente compartilháveis, garantindo também, dessa forma, maior potencial para reprodutibilidade
...
.pull-left[
<img width="60%" src="https://dalmolingroup.imd.ufrn.br/wp-content/themes/wpeducon-dalmolin/images/logo.png">
